...
const Learn = () => (
	...
	>
		...
		/>
		<p className="font-joti text-stone-600 pt-10 text-[30px]">Click on a bird to learn more!</p>
		...
		<Bird
			name="American Crow"
			image="/crow.png"
			style="absolute top-30 right-1/5 h-[20%] w-auto"
		/>

		<Bird
			name="Northern Cardinal"
			image="/northern_cardinal.png"
			style="absolute top-124 left-4/6 h-[20%] w-auto"
		/>
		<Bird
			name="Rock Pigeon"
			image="/pigeon.png"
			style="absolute bottom-16 left-1/5 h-[15%] w-auto"
		/>
		<Bird
			name="American Robin"
			image="/robin.webp"
		...
		<Bird
			name="House Sparrow"
			image="/sparrow.png"
			style="absolute top-100 left-1/5 h-[20%] w-auto"
		/>
