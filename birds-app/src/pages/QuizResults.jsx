...
const QuizResults = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center px-5">
      ...
      {/* Bird Image  */}
      <div className="absolute top-0 right-0 m-15">
        <img src={crow} alt="crow" className="w-60 h-auto" />
      </div>

      <div className="mb-20 max-w-5xl w-full flex flex-col md:flex-row items-center justify-between bg-gray-100 p-8 rounded-xs p-15 inset-shadow-sm inset-shadow-gray-300">
        {/* Text Section */}
